  ...
  return (
    ...
    <View>
      <Text
        ...
        <Pressable style={{position:'absolute', left:8, top:24,  padding:8}} onPress={() =>navigation.navigate('paginaInicial')}>
          <Icon
            color="white"
            name="arrow-left"
            size={24}
    ...
    <View style={styles.tudo}>
      <View style={styles.borda}>
        <View style={styles.imagem}>
          ...
          <Text style={{marginTop:8,color:'#0073e6', fontSize:20,fontWeight:'bold'}}>Oceano</Text>
        </View>
      ...
      <View style={styles.borda}>
        <View style={styles.imagem}>
          ...
          <Text style={{marginTop:8,color:'#0073e6', fontSize:20,fontWeight:'bold'}}>Deserto</Text>
        </View>
        <View style={styles.corpo}>
          <Text style={styles.fonte}>30 min</Text>
          <Text style={styles.fonte}>45 min</Text>
      ...
      <View style={{width:'100%'}}>
        <View style={styles.imagem}>
          ...
          <Text style={{marginTop:8,color:'#0073e6', fontSize:20,fontWeight:'bold'}}>Morning</Text>
        </View>
        <View style={styles.corpo} >
          <Text style={styles.fonte}>30 min</Text>
          <Text style={styles.fonte}>45 min</Text>
